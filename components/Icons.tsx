...
export const TextBoxIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M3 3h18v18H3V3zm12.75 3.75h-7.5" />
...
export const WrenchScrewdriverIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" d="M11.42 15.17L17.25 21A2.652 2.652 0 0021 17.25l-5.877-5.877M11.42 15.17l2.471-2.471a.563.563 0 01.8 0l2.471 2.471M12 8.25c-.995 0-1.924-.4-2.612-1.121a3.52 3.52 0 010-4.846A3.52 3.52 0 019.388 2.25c.995 0 1.924.4 2.612 1.121a3.52 3.52 0 010 4.846A3.52 3.52 0 0112 8.25z" />
    </svg>
);
...
export const RectangleGroupIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 12.125A2.25 2.25 0 014.5 9.875h15A2.25 2.25 0 0121.75 12.125v5.5A2.25 2.25 0 0119.5 19.875h-15A2.25 2.25 0 012.25 17.625v-5.5z" />
    </svg>
);
export const ViewfinderCircleIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126zM12 15.75h.007v.008H12v-.008z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 3.75H4.5v3.75" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 16.5v2.25h3.75" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 20.25h2.25v-3.75" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 7.5V4.5h-3.75" />
    </svg>
);
export const DocumentIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 7.5V6.375A2.25 2.25 0 1112.75 8.25H18a2.25 2.25 0 012.25 2.25v7.5A2.25 2.25 0 0118 20.25H6A2.25 2.25 0 013.75 18v-7.5A2.25 2.25 0 016 8.25h1.5" />
    </svg>
);
export const DocumentMinusIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 9V6.375A2.25 2.25 0 1011.25 8.25h-1.5A2.25 2.25 0 007.5 6V5.25A2.25 2.25 0 019.75 3h4.5A2.25 2.25 0 0116.5 5.25v3.75m-3.75 0h-1.5m-3 3.75H3a2.25 2.25 0 00-2.25 2.25v5.25A2.25 2.25 0 003 21h18a2.25 2.25 0 002.25-2.25v-5.25A2.25 2.25 0 0018.75 9h-3.75" />
    </svg>
);

// Icons from old AddTextModal
...
export const UnderlineIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M6 6v6a3 3 0 003 3h6a3 3 0 003-3V6M4.5 21h15" />
  </svg>
);
...
export const DiamondIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 21l-3.5-3.5M12 21l3.5-3.5M12 21V3M12 3l-3.5 3.5M12 3l3.5 3.5" />
  </svg>
);
